...
LRTp_45 = calc_lrt(598, mlcmm_QFQMLR4_tf_gridsearch$loglik,33, mlcmm_QFQMLR4_tf_gridsearch$ng, mlcmm_QFQM5_tf_gridsearch$loglik, 38, mlcmm_QFQM5_tf_gridsearch$ng)
...
#clusters_4_multLCMM is from python script, full cohort with all features and clusters
